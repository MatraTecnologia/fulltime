    ...
    <main className="mx-auto max-w-4xl px-6 py-12">
      ...
      {course.modules.length > 0 && (
        <section className="mt-10">
          <h2 className="mb-4 text-xl font-bold text-foreground">Currículo do curso</h2>
              ...
              <AccordionItem key={m.id} value={m.id}>
                ...
                <AccordionContent>
                  <ul className="space-y-2 px-6 pb-2">
                    {m.lessons.map((l) => (
                      <li key={l.id} className="flex items-center gap-2.5 text-sm text-muted-foreground">
